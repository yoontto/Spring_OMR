...
<header style="border-bottom: 1px solid black; padding: 15px 0; text-align: left;">
		...
		<div
			style="position:absolute; right: 0; top: 25px; margin-left: 100px"
		>
			<ul>
			<!-- 로그인 된 경우 안된 경우 나중에 기능 추가 해야됨 (소셜 로그인) -->
			...
			<!-- 로그인 한 경우 -->
				<c:if test="${!empty loginInfo}">
					<li><a class="btn-fill">${loginIngo.name }</a></li>
