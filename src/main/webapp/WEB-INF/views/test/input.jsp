...
문제문항 작성 : <input type="text" name="test_problem" /><br/>
문제보기1 작성 : <input type="text" name="test_choice1" /><br/>
문제보기2 작성 : <input type="text" name="test_choice2" /><br/>
문제보기3 작성 : <input type="text" name="test_choice3" /><br/>
문제보기4 작성 : <input type="text" name="test_choice4" /><br/>
정답선택 : 
<label for='answer1'> 1 </label><input type="radio" id = "answer1" name="test_answer" value="1"/>
